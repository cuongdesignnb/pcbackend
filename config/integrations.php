...
return [
    'kiot' => [
        ...
        'product_sync_max_tombstones' => env('KIOT_PRODUCT_SYNC_MAX_TOMBSTONES', 100),
        'product_sync_max_tombstone_ratio' => env('KIOT_PRODUCT_SYNC_MAX_TOMBSTONE_RATIO', 0.30),
        'product_sync_tombstone_ratio_min_items' => env('KIOT_PRODUCT_SYNC_TOMBSTONE_RATIO_MIN_ITEMS', 20),
