...
<AdminLayout title="Thêm thương hiệu">
    <div class="max-w-2xl">
        <div class="flex items-center justify-between mb-6"><h3 class="text-lg font-semibold text-slate-200">Thêm thương hiệu</h3><Link href="/admin/brands" class="text-sm text-slate-400 hover:text-slate-300">← Quay lại</Link></div>
        <form @submit.prevent="submit" class="bg-slate-900 rounded-lg shadow-none border border-slate-800/60 p-6 space-y-4">
            ...
            <div><label class="block text-sm font-medium text-slate-300 mb-1">Website</label><input v-model="form.website" class="w-full border border-slate-700/50 rounded-lg px-3 py-2 text-sm" placeholder="https://..."></div>
