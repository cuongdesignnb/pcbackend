...
<AdminLayout title="Thêm quy tắc tương thích">
    <div class="max-w-2xl">
        <div class="flex items-center justify-between mb-6"><h3 class="text-lg font-semibold text-gray-900">Thêm quy tắc</h3><Link href="/admin/compatibility" class="text-sm text-gray-500 hover:text-gray-700">← Quay lại</Link></div>
