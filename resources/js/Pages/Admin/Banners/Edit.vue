...
<AdminLayout title="Sửa banner">
    <div class="max-w-2xl">
        <div class="flex items-center justify-between mb-6"><h3 class="text-lg font-semibold text-gray-900">Sửa banner</h3><Link href="/admin/banners" class="text-sm text-gray-500 hover:text-gray-700">← Quay lại</Link></div>
